...
| | Upstream | This Fork |
|---|---|---|
| Negative balances | Allowed, requires re-deposit before crafting resumes. This is an intentional feature/design decision upstream, not a bug. Don't assume as such. | Clamped to zero, matching vanilla ARK — see tradeoffs below |
